...
# Lade die Fragen
data = load_questions_from_json('data/4_entwurf_des_softwaredesigns.json')
...
st.page_link("pages/f_softwareintegration.py", label="Evaluate", use_container_width=True, icon="👍")
