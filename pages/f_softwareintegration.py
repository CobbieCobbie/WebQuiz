...
# Lade die Fragen
data = load_questions_from_json('data/5_testen_von_softwareintegration.json')
...
st.page_link("pages/g_organisation.py", label="Evaluate", use_container_width=True, icon="👍")
