...
# Lade die Fragen
data = load_questions_from_json('data/2_system_softwareanforderungsanalyse.json')
...
st.page_link("pages/d_architecture.py", label="Evaluate", use_container_width=True, icon="👍")
