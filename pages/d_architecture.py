...
# Lade die Fragen
data = load_questions_from_json('data/3_entwurf_der_systemarchitektur.json')
...
st.page_link("pages/e_softwaredesign.py", label="Evaluate", use_container_width=True, icon="👍")
